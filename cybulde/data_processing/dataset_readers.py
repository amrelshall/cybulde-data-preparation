...
class JigsawToxicCommentsDatasetReader(DatasetReader):
    ...
    def _read_data(self) -> tuple[dd.core.DataFrame, dd.core.DataFrame, dd.core.DataFrame]:
        ...
        test_df = test_df.merge(test_labels_df, on=["id"])  # merge the test df and the test label df using id
        test_df = test_df[test_df["toxic"] != -1]  # get rid of -1 value cuz we dont need it in our project
